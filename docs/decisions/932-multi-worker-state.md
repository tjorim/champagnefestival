...
Consolidated 2026-09-08. The [full pre-consolidation document](https://github.com/tjorim/champagnefestival/blob/88396baf3275ae40cdd907239a0df6a04baed137/docs/decisions/932-multi-worker-state.md) preserves the original findings, proposals, acceptance criteria, and implementation history.
