...
vi.mock('@/config/schedule', () => ({
  ...
  scheduleEvents: [
    { id: 'fri-tasting', title: 'Tasting', startTime: '17:00', endTime: '23:00', description: 'Tasting event', category: 'tasting', dayId: 1 },
    { id: 'fri-vip', title: 'VIP', startTime: '19:30', description: 'VIP event', category: 'vip', dayId: 1, reservation: true },
    { id: 'sat-party', title: 'Party', startTime: '20:00', description: 'Party event', category: 'party', dayId: 2 },
  ],
}));
