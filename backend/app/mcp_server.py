...
def create_mcp_server(
    ...
    mcp.tool(backend.list_venues)
    mcp.tool(backend.get_venue)
    mcp.tool(backend.update_venue)
    mcp.tool(backend.delete_venue)
    mcp.tool(backend.create_room)
    mcp.tool(backend.list_rooms)
    mcp.tool(backend.get_room)
    mcp.tool(backend.update_room)
    mcp.tool(backend.delete_room)
    mcp.tool(backend.create_table_type)
    mcp.tool(backend.list_table_types)
    mcp.tool(backend.get_table_type)
    mcp.tool(backend.update_table_type)
    mcp.tool(backend.delete_table_type)
    mcp.tool(backend.create_table)
    mcp.tool(backend.list_tables)
    mcp.tool(backend.get_table)
    mcp.tool(backend.update_table)
    mcp.tool(backend.delete_table)
    mcp.tool(backend.create_layout)
    mcp.tool(backend.copy_layout)
    mcp.tool(backend.list_layouts)
    mcp.tool(backend.get_layout)
    mcp.tool(backend.delete_layout)
    mcp.tool(backend.create_area)
    mcp.tool(backend.list_areas)
    mcp.tool(backend.get_area)
    mcp.tool(backend.update_area)
    mcp.tool(backend.delete_area)
    mcp.tool(backend.create_edition)
    mcp.tool(backend.get_edition)
    mcp.tool(backend.update_edition)
    mcp.tool(backend.delete_edition)
    mcp.tool(backend.create_event)
    mcp.tool(backend.get_event)
    mcp.tool(backend.update_event)
    mcp.tool(backend.delete_event)
    mcp.tool(backend.create_faq_item)
    mcp.tool(backend.list_faq_items)
    mcp.tool(backend.update_faq_item)
    mcp.tool(backend.delete_faq_item)
    mcp.tool(backend.get_settings)
    mcp.tool(backend.set_maintenance_mode)
    mcp.tool(backend.create_exhibitor)
    mcp.tool(backend.get_exhibitor)
    mcp.tool(backend.list_exhibitors)
    mcp.tool(backend.update_exhibitor)
    mcp.tool(backend.delete_exhibitor)
    mcp.tool(backend.create_person)
    mcp.tool(backend.get_person)
    mcp.tool(backend.update_person)
    mcp.tool(backend.delete_person)
    mcp.tool(backend.merge_people)
    mcp.tool(backend.create_member)
    mcp.tool(backend.get_member)
    mcp.tool(backend.list_members)
    mcp.tool(backend.update_member)
    mcp.tool(backend.delete_member)
    mcp.tool(backend.create_volunteer)
    mcp.tool(backend.get_volunteer)
    mcp.tool(backend.list_volunteers)
    mcp.tool(backend.update_volunteer)
    mcp.tool(backend.delete_volunteer)
    mcp.tool(backend.create_registration)
    mcp.tool(backend.update_registration)
