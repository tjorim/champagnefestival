 ...
 */
const LocationInfo: React.FC<LocationInfoProps> = ({ dictionary }) => {
  return (
      ...
      <Card.Body className="p-4">
        ...
        <Row>
          <Col md={6} className="mb-3 mb-md-0">
            <div className="mb-4">
              <h5>{dictionary.location.address}</h5>
          ...
          <Col md={6}>
            <div>
              <h5>{dictionary.location.openingHours}</h5>
              <p>{dictionary.location.openingHoursValue}</p>
            </div>
          </Col>
        </Row>
      </Card.Body>
