...
export const seedRegistrations = [
  {
    ...
    table_id: "table-01",
    allocations: [{ table_id: "table-01", guest_count: 1, exclusive: false }],
    booked_table_quantity: 0,
    status: "confirmed",
    payment_status: "paid",
    checked_in: false,
    checked_in_at: null,
  ...
  },
  {
    ...
    table_id: "table-02",
    allocations: [{ table_id: "table-02", guest_count: 1, exclusive: false }],
    booked_table_quantity: 0,
    status: "confirmed",
  ...
  },
  {
    ...
    table_id: "table-03",
    allocations: [{ table_id: "table-03", guest_count: 1, exclusive: false }],
    booked_table_quantity: 0,
    status: "pending",
    payment_status: "unpaid",
    checked_in: false,
